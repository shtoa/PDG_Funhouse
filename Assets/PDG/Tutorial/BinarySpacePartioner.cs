...
{
    public class BinarySpacePartioner
    {
        RoomNode rootNode;
        ...
        public BinarySpacePartioner(int dungeonWidth, int dungeonLength)
        {
        ...
        private void SplitSpace(RoomNode currentNode, List<RoomNode> listToReturn, int roomLengthMin, int roomWidthMin, Queue<RoomNode> graph)
        {
            ...
            if (line.Orientation == Orientation.Horizontal) // original horizontal
            {
                node1 = new RoomNode(
        ...
        private Line GetLineDividingSpace(Vector2Int bottomLeftAreaCorner, Vector2Int topRightAreaCorner, int roomWidthMin, int roomLengthMin)
        {
            ...
            return new Line(orientation, GetCoordinatesForOrientaiton(
                orientation,
        ...
        private Vector2Int GetCoordinatesForOrientaiton(Orientation orientation, Vector2Int bottomLeftAreaCorner, Vector2Int topRightAreaCorner, int roomWidthMin, int roomLengthMin)
        {
